...
class Marker:
    def __init__(self):
        self.position = 0 # Position in the data block
        self.points = 0 # Number of points in the marker
        self.channel = -1 # Channel number, -1 if not specified
        self.type = "" # Type of the marker, e.g., "Event"
        self.description = "" # Description of the marker, e.g., "Stimulus A"
